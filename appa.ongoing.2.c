...
int main(void)
{
  // Initialize everything in the beginning
  servo_init();
  adc_init();
  ...
  while(1==1)
    {
      // Look towards the right for anything that we might bump into
      visionSweep= 0;
      ...
      while(visionSweep < 30)
	{
      ...
      // Look towards the left for anything that we might bump into
      visionSweep= 0;
